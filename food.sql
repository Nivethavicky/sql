...
VALUES 
    -- For restaurant 1
    (1, 'Masala Dosa', 'Fermented crepe made from rice batter and black lentils, filled with spiced potato', 200),
    (1, 'Idli', 'Steamed cake made from fermented rice and black lentils', 250),
    (1, 'Vada', 'Fried savory doughnut made from lentil batter, served with chutney and sambar', 220),
    (1, 'Pongal', 'Savory rice dish made with rice and lentils, flavored with cumin and black pepper', 180),
    (1, 'Uttapam', 'Thick pancake made from fermented rice and lentil batter, topped with vegetables', 300),
    (1, 'Puri Bhaji', 'Deep-fried bread served with spicy potato curry', 220),
    (1, 'Upma', 'Savory South Indian dish made from semolina, served with chutney', 180),
    (1, 'Chapati', 'Thin unleavened flatbread, served with dal or curry', 150),
    (1, 'Parotta', 'Layered flatbread made from maida flour, served with side dish', 250),
    (1, 'Bisi Bele Bath', 'Spicy rice dish made with rice, lentils, vegetables, and spices', 300),
    (1, 'Puliyogare', 'Spicy tamarind rice dish cooked with peanuts, sesame seeds, and spices', 280),
    (1, 'Ghee Roast Dosa', 'Crispy crepe made from rice and lentil batter, roasted in ghee', 270),
    (1, 'Mysore Masala Dosa', 'Crispy crepe filled with spicy potato filling and chutney', 300),
    (1, 'Rava Idli', 'Soft and fluffy idlis made from semolina and rice flour', 250),
    -- For restaurant 2
